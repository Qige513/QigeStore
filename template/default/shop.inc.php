...
//经典模式
    ...
    <div id="goodTypeContents">
        ...
        <?php if ($conf['shoppingcart'] == 1) { ?>
            <div class="btn-group btn-group-justified form-group">
                <a class="btn btn-block btn-success" type="button" id="submit_cart_shop" style="-webkit-appearance: none;">加入购物车</a>
                <a type="submit" id="submit_buy" class="btn btn-block btn-primary" style="-webkit-appearance: none;">立即购买</a>
            </div>
        <?php } else { ?>
            <div class="form-group">
                <input type="submit" id="submit_buy" class="btn btn-primary btn-block" value="立即购买">
