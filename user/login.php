...
<div class="col-xs-12 col-sm-10 col-md-8 col-lg-4 center-block " style="float: none;">
    ...
    <div class="widget">
            ...
            <form>
                <div class="input-group">
                    ...
                    <input type="text" name="user" value="<?php
                        //后台 点击登录用户操作
                        $user_info = $DB->get('site', '*', ['zid' => $_GET['zid']]);
                        echo '';
                ...
                <div class="input-group">
                    ...
                    <input type="password" name="pass" value="<?php
                        ...
                        if (isset($user_info['pwd'])){
                            echo $user_info['pwd'];
                        }?>" class="form-control" required="required" placeholder="密码"/>
                </div>
                <br/>
                ...
                <div class="row">
                    <?php if($conf['qq_status'] == 1){?>
                    <div class="col-xs-12 col-sm-6">
                        <a href="javascript:" class="btn btn-block btn-default mb-1" id="qq_login">
                            <i class="fa fa-qq text-blue"></i> 使用QQ登录
                        </a>
                    </div>
                    <?php } ?>
                    <div class="col-xs-12 col-sm-6">
                        <a href="javascript:" class="btn btn-block btn-default mb-1" id="wx_login" disabled data-toggle="tooltip" data-title="仅支持微信公众号内登录" data-original-title="" title="">
                            <i class="fa fa-wechat text-green"></i> 使用微信登录
                        </a>
                    </div>
                </div>
                <hr>
        ...
        <?php include TEMPLATE_ROOT . 'official/xiang.php'; ?>
    </div>
