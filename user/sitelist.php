...
//                    showmsg('删除失败！' . $DB->error(), 4);
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        foreach ($rs as $res) {
                            echo '<tr><td><b>' . $res['zid'] . '</b></td><td>' . $res['user'] . '</td><td>' . $res['sitename'] . '<br/>' . $res['qq'] . '</td><td>' . $res['rmb'] . '</td><td>' . $res['addtime'] . '<br/>' . $res['endtime'] . '</td><td>' . $res['domain'] . '<br/>' . $res['domain2'] . '</td><td><a href="./sitelist.php?my=edit&zid=' . $res['zid'] . '" class="btn btn-info btn-xs">编辑</a></td></tr>';
                        }
                        ?>
                        </tbody>
                    </table>
