    ...
    <div class="block full2">
        ...
        <div class="block-title">
            ...
            <ul class="nav nav-tabs" id="panel-heading"
                ...
                <li style="width: 25%;" align="center" class="active"><a href="#shop" data-toggle="tab">
                ...
                <li style="width: 25%;" align="center" <?php if ($conf['fenzhan_buy'] == 0){ ?>class="hide"<?php } ?>>
                    <a href="#Substation" data-toggle="tab">
                        <span style="font-weight:bold">
                            <font color="#ff0000"><i class="fa fa-coffee fa-fw"></i>加盟</font>
                        </span>
                    </a></li>
                ...
                <li style="width: 25%;" align="center" <?php if ($conf['iskami'] == 0){ ?>class="hide"<?php } ?>>
