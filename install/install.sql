...
INSERT INTO `shua_config` VALUES ('version', '8.9.5');
...
INSERT INTO `shua_config` VALUES ('wxpay_api', '2');
INSERT INTO `shua_config` VALUES ('qq_status', '1');
INSERT INTO `shua_config` VALUES ('style', '1');
INSERT INTO `shua_config` VALUES ('cdnpublic', '1');
INSERT INTO `shua_config` VALUES ('sitename', 'Qige Store');
INSERT INTO `shua_config` VALUES ('keywords', 'QQ业务网,云商城,代刷网,自助下单,网红助手,网红速成,Qige系统,Qige Store');
INSERT INTO `shua_config` VALUES ('description', 'QQ业务网，专业提供国内网红速方案，帮您走出网红的第一步，我们提供最专业的售前指导，提供最优质的售后服务，给您一个放心的平台！');
...
<a target="_blank" class="btn btn-info" href="http://wpa.qq.com/msgrd?v=3&uin=3573569571&site=qq&menu=yes"><i class="fa fa-qq"></i>联系客服</a>
<a target="_blank" class="btn btn-warning" href="https://jq.qq.com/?_wv=1027&k=rcLMmONE"><i class="fa fa-users"></i> 官方Q群</a>
...
<tbody>
<tr height="50">
<td><button type="button" class="btn btn-block btn-warning"><a href="https://jq.qq.com/?_wv=1027&k=rZQdwbZj" target="_blank"><span style="color:#ffffff">♚加群1♚</span></a></button></td>
<td><button type="button" class="btn btn-block btn-warning"><a href="https://jq.qq.com/?_wv=1027&k=rcLMmONE" target="_blank"><span style="color:#ffffff">♚加软件系统群♚</span></a></button></td>
</tr>
<tr height="50">
<td><button type="button" class="btn btn-block btn-success"><a href="http://qgame.eu5.org/" target="_blank"><span style="color:#ffffff">♚游戏小站♚</span></a></button></td>
...
INSERT INTO `shua_config` VALUES ('faka_mail', '<b>商品名称：</b> [name]<br/><b>购买时间：</b>[date]<br/><b>以下是你的卡密信息：</b><br/>[kmdata]<br/>----------<br/><b>使用说明：</b><br/>[alert]<br/>----------<br/>QQ业务网自助下单平台<br/>[domain]');
...
CREATE TABLE `shua_workorder_speedy` (
  ...
  `text` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '快捷回复记录';
...
INSERT INTO `shua_config` VALUES ('order_set',0);